            ...
            <div class="card-body">
                ...
                <div class="row p-3">
                    ...
                    <div class="col-lg-12 col-12 mt-2">
                        ...
                        <input name="file" type="file" accept="image/*" data-default-file="{{ isset($setting->section3_background) ? asset('sections/'.$setting->section3_background) : '' }}" class="dropify" data-height="100" />
                    </div>
                    <div class="col-lg-12 col-12 mt-2">
                        <label for="">Text on this Section</label>
                        <textarea name="text" type="text"  value="" class="form-control" data-height="100" >{{$setting->section3_text}}</textarea>
                    </div>
