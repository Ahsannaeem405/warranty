    ...
    <div class="col-12">
        <div class="card" style="width:100%;">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ route('save.logo') }}" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                <div class="row p-3">
                    <!-- <form> -->
                    <div class="col-lg-12 col-12 mt-2">
                        <label for="">Change Website Logo</label>
                        <input name="logo" type="file" accept="image/*" data-default-file="{{ isset($setting->site_logo) ? asset('site_logo/'.$setting->site_logo) : '' }}" class="dropify" data-height="100" />
                    </div>
