                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Users</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> {{App\Models\User::where("is_admin","0")->get()->count()}} </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Event Planners
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    <?php foreach ($graph as  $value): ?>
        "{{Carbon\Carbon::create($value->date)->format('d M')}}",
    <?php endforeach ?>
